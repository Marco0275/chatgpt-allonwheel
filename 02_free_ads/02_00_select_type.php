<?php
// ============================================================
// 02_free_ads/02_00_select_type.php
...
//      con 02_insert_ad.php (resto dell'annuncio free).
//
...
// Flusso FORZATO solo su Annunci FREE (Modulo 02)
$aow_sel = 'free';

if ($user_id !== null) {
  // Utente loggato: verifica solo le quote per annunci FREE
  $aow_check_free = UserTier::canInsertFreeAd($pdo, $user_id);
  if (!$aow_check_free['allowed']) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($from === 1) {
    ...
    if ($kind === VehicleTaxonomy::KIND_SHELTER) {
      // Shelter/Container: salva per modulo FREE ('02')
      $_SESSION['ad_wizard'] = [
        'module'         => '02',
      ...
      header('Location: 02_insert_ad.php');
      exit;
    }
...
// Elenco tipologie per lo step 3
...
<title>All on Wheel Ltd - Classify free ad</title>
...
<div id="templatemo_wrapper">
  ...
  <div id="main"></div><div id="templatemo_content">
    ...
    <?php if ($step === 1): ?>
      <!-- STEP 1: tipo oggetto -->
      <form action="02_00_select_type.php" method="post">
        <?php echo csrf_generate_persistent(); ?>
        <input type="hidden" name="wizard_step" value="1" />
        <div class="form_row">
          <label><strong>Choose the kind of item:</strong><br><br></label>
        </div>
        <div class="cat-grid">
    ...
    <?php elseif ($step === 2): ?>
      ...
      <form action="02_00_select_type.php" method="post">
        ...
        <div class="form_row">
          <label><strong>Vehicle macro-category:</strong><br><br></label>
        </div>
        <div class="cat-grid">
        ...
        <div class="form_row">
          <p>
            <button type="submit" value="Next" class="more float_r">Next</button>
            <a href="02_00_select_type.php" class="more float_l">Back</a>
          </p>
        </div>
      </form>
    ...
    <?php else: ?>
      ...
      <form action="02_00_select_type.php" method="post">
        ...
        <div class="form_row">
          <strong><?php echo ucfirst($macro); ?></strong> => choose the type (If you can't find it in the list below, please go back and select ROAD):<br><br>
        </div>
        <?php if (empty($types)): ?>
