<?php
// ============================================================
// 02_free_ads/02_02_delete_image_gallery.php
// Elimina una singola immagine dalla 02_free_ads_gallery di un annuncio
// (tabella: gallery, modulo: 02_free_ads).
//
...
// Wizard unificato: la stessa pagina serve free (02_free_ads) e premium (03_ads)
...
try {
  ...
  header('Location: ' . BASE_URL . '/02_free_ads/02_insert_ad_gallery.php?id_ads=' . $id_ads . ($aow_lt === 'prem' ? '&lt=prem' : ''));
  exit;
}
...
if ($aow_ret) {
  $aow_back = ($aow_lt === 'prem')
    ...
    : '/02_free_ads/02_insert_ad_gallery.php?id_ads=' . $id_ads;
} else {
  $aow_back = '/02_free_ads/02_insert_ad_gallery.php?id_ads=' . $id_ads . ($aow_lt === 'prem' ? '&lt=prem' : '');
}
