<?php
// ============================================================
// 02_free_ads/02_save_draft.php  Salvataggio bozza dell'ospite (punto 2)
//
// 17 lug 2026. Dove POSTa l'OSPITE quando preme "Register to publish" nel
// form annuncio (02_insert_ad.php). NON e' l'handler di pubblicazione: qui
...
$_SESSION['redirect_after_login'] = '/02_free_ads/02_insert_ad.php';
