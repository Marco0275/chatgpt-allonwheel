<?php
// ============================================================
// 02_free_ads/02_insert_ad_image.php
...
<div id="templatemo_wrapper">
  ...
  <div id="main"></div><div id="templatemo_content">
    ...
    <form action="02_01_upload_ad_image.php" method="post" enctype="multipart/form-data">
    ...
    <a class="more float_r" href="02_preview_ad.php?id_ads=<?php echo $id_ads; ?>">Continue</a>
    <div class="cleaner"></div>
    </div>
    <div class="cleaner"></div>
  </div>
