		...
		function start_pirobox() {
			...
			var gall_settings = new Array();
				for (var key in map) {
					...
					/* avviso dev disattivato: nessun pop-up per singola immagine */
					}
				}
			...
			$(piro_gallery).each(function(array) {
				...
				img.onerror = function (){
					main_cont.removeClass('loading'); // FIX: dopo un errore i click successivi venivano ignorati
				...
				img.onload = function() {
				  ...
				  $(opt.close_all).bind('click',function(c) {
					clearTimeout(timer);
					c.preventDefault();
					// FIX: chiudi e sblocca SEMPRE. Prima il gate $(img).is(':visible')
					// bloccava la chiusura quando era mostrato il messaggio d'errore,
					// lasciando 'loading' attivo e il lightbox inutilizzabile.
					main_cont.removeClass('loading');
					$('.err_mess').remove();
