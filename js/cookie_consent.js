...
(function () {
  ...
  // P0.5: link "Cookie preferences" nel footer riapre il banner.
  document.addEventListener("click", function (e) {
    var t = e.target.closest ? e.target.closest("[data-aow-cc-open]") : null;
    if (t) { e.preventDefault(); var b = document.getElementById("aow-cookie-banner"); if (b) b.hidden = false; }
  });
})();
