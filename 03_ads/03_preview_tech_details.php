<?php
// Uniformato a session_helper (24 lug 2026): login via require_user_logged_in()
// al posto del gate manuale su $_SESSION['session_id'].
...
if (!$tech) {
  echo "Nessun dettaglio tecnico trovato per questo annuncio.";
  exit;
}
...
<div id="content_top">
  <div id="page_title">Preview tech details</div>
  <div id="search_box">
...
<div id="main"></div><div id="templatemo_content">
  ...
  <table width="100%" border="0">
   ...
   <td scope="col">Number of cars:
    <input name="cars" type="text" id="cars" value="<?= htmlspecialchars($tech['cars']) ?>" maxlength="6" />
   </td>
   </tr>
 </table>
 ...
 mm</span></td>
 <td><span class="checkbox">
   <input name="Lift_capacity" type="text" id="Lift_capacity" value="<?= htmlspecialchars($tech['Lift_capacity']) ?>" maxlength="6" />
 </span></td>
  </tr>
  <tr>
 <td></td>
 ...
 mm</span></td>
  ...
  <div class="cleaner h20"></div>
	  <div class="cleaner h20"></div>
<a class="more float_r" href="03_preview_ad.php?id_ads=<?php echo $id_ads; ?>">Back</span></a></div>
</div>
