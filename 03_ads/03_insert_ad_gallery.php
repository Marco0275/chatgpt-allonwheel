...
<div id="main"></div><div id="templatemo_content">
  ...
  <div id="contact_form">
    <form action="03_01_upload_gallery.php" method="POST" enctype="multipart/form-data">
    ...
    <table width="100%">
      <tbody>
        ...
        <td width="20%" valign="bottom">
          <button type="submit" name="submit" id="submit" value="Upload image" class="more float_l">Upload image</button>
        </td>
        </tr>
      </tbody>
    </table>
...
<div class="cleaner h20"></div>
  ...
  <div class="gallery">
    ...
    <div class="image-box thumb_wrap">
      ...
      <form action="03_02_delete_image_gallery.php" method="POST" >
        <?php if ($aow_lt === 'prem'): ?><input type="hidden" name="lt" value="prem" /><?php endif; ?>
        <?php echo csrf_generate_persistent(); ?>
...
<?php else: ?>
<a class="more float_r" href="03_preview_ad.php?id_ads=<?php echo (int)$id_ads; ?>">Continue</a>
<?php endif; ?>
</div>
