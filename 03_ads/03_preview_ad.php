...
try {
 $query = "SELECT * FROM `03_ads` WHERE id_ads = :id_ads";
...
<div id="templatemo_wrapper">
 ...
 <div id="contact_form">
  <div class="gallery_box">
	<ul class="gallery">
	<li>
	  <a class="pirobox" href="/upload_image/03_ads/original/<?= htmlspecialchars($row_richiama_ads['image_original']) ?>" 
		 title="<?= htmlspecialchars($row_richiama_ads['title']) ?>">
		<img src="/upload_image/03_ads/thumbnail/<?= htmlspecialchars($row_richiama_ads['image_thumbnail']) ?>" 
...
<div><strong style="text-align: right">Modify:</strong>
   <a class="more float_r" href="03_modify_insert_ad.php?id_ads=<?php echo $id_ads; ?>">Advertising</a>
<div class="cleaner h20"></div><a class="more float_r" href="03_insert_ad_gallery.php?id_ads=<?php echo $id_ads; ?>">Gallery</a>
 </div>
	     <div class="cleaner h20"></div>
	<div class="cleaner h20"></div>
	 <div class="cleaner h20"></div>
<div><strong style="text-align: right">Preview:</strong>
	 <a class="more float_r" href="03_preview_gallery.php?id_ads=<?php echo $id_ads; ?>">Gallery</a>
    <div class="cleaner h20"></div>
	<div class="cleaner h20"></div>
	<a class="more float_r" href="03_view_ads.php">Confirm</a></div>
 </div>
