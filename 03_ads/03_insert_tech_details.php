<?php
// ============================================================
// 03_ads/03_insert_tech_details.php - Form scheda tecnica premium.
...
if (!PlanPolicy::canTechDetails(UserTier::getTier($pdo, $id_user))) {
    $_SESSION['error_message'] = 'Technical details are available on Premium and Gold plans.';
...
<script type="text/javascript" src="../js/site_init.js" defer></script>
	...
	<style>
/* Evita che il testo delle tabelle vada a capo */
...
/* Mantiene le checkbox e il testo sulla stessa riga */
...
<div id="content_top">
 <div id="page_title">Insert tech details</div>
 <div id="search_box">
...
<div id="main"></div><div id="templatemo_content">
 <p>Adding technical details about your vehicle: it means to have more probability to find someone interested.</p>
 <div id="contact_form">
...
<td scope="col">Number of cars:
 ...
 <td colspan="3" class="checkbox" scope="col"><strong>General options</strong></td>
  ...
  <tr>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Awning" name="Awning" width="one-third" value="1" />Awning&nbsp;</span></td>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Workshop" name="Workshop" width="one-third" value="1" />Workshop&nbsp;</span></td>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Belly" name="Belly" width="one-third" value="1" />Belly Lockers</span></td>
  </tr>
  <tr>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Kitchen" name="Kitchen" width="one-third" value="1" /> Kitchen&nbsp;</span></td>
 <td><span class="checkbox"> <input type="checkbox" class="control control--checkbox"id="Beds" name="Beds" width="one-third" value="1" />Beds</span></td>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Genset" name="Genset"
  width="one-third" value="1" />Genset</span></td>
  </tr>
  <tr>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Bathroom" name="Bathroom" width="one-third" value="1" />Bathroom</span></td>
 <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="SAT" name="SAT" width="one-third" value="1" />SAT</span></td>
 <td></td>
  </tr>
  </table>
  <div class="cleaner h10"></div>
 ...
 <input name="Lift_manufactorer" type="text" class="required input_field" id="Lift_manufactorer" />
 </span></td>
  </tr>
  </table>
  <table width="100%">
 ...
 <td><span class="checkbox">Capacity:</span></td>
  ...
  <tr>
    <td width="33%"><span class="checkbox">
    ...
    <td width="33%"><span class="checkbox">
      ...
      mm</span></td>
    <td width="33%" valign="top"><span class="checkbox">
  ...
  <tbody>
    <tr>
      <td colspan="2"><span class="checkbox"><strong>Cargo Facilities</strong></span></td>
      </tr>
    <tr>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="rails" name="rails" width="one-third" value="1" />Mounting rails on the floor</span></td>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="LED" name="LED" width="one-third" value="1" />LED lights</span></td>
    </tr>
    <tr>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="independent_entrance_cargo" name="independent_entrance_cargo" width="one-third" value="1" />
        Independent entrance</span></td>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Fixing" name="Fixing" width="one-third" value="1" />Fixing points to strap cars</span></td>
    </tr>
    <tr>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Cabinets" name="Cabinets" width="one-third" value="1" />Cabinets</span></td>
      <td><span class="checkbox"><input type="checkbox" class="control control--checkbox"id="Adjustable" name="Adjustable" width="one-third" value="1" />Adjustable second deck</span></td>
    </tr>
  </tbody>
</table>
 ...
 <td align="left"><span class="checkbox">
 ...
 <td align="left"><span class="checkbox">
 <input name="axles" type="text" id="axles" maxlength="1" />
 </span></td>
  </tr>
  <tr>
 <td><span class="checkbox">
 ...
 <td><span class="checkbox">Maximum Gross Weight [kg]:</span></td>
 <td align="left"><span class="checkbox">
 <input name="MGW" type="text" id="MGW" maxlength="5" />
 </span></td>
  </tr>
  <tr>
 <td><span class="checkbox">
 ...
 class="control control--checkbox"id="chassis_special" name="chassis_special"
  width="one-third" value="1" />
 Special</span></td>
 <td><span class="checkbox">Saddle height [mm]:</span></td>
 <td align="left"><span class="checkbox">
 <input name="Saddle" type="text" id="Saddle" maxlength="5" />
 </span></td>
  </tr>
  </table>
  <div class="cleaner h10"></div>
 ...
 <td colspan="3" scope="col"><span class="checkbox"><strong>External dimension</strong></span></td>
  ...
  <tr>
 <td></td>
 <td><span class="checkbox">Length [mm]:</span></td>
 <td><span class="checkbox">
 <input name="ext_length" type="text" id="ext_length" value="" maxlength="5" />
  ...
  <tr>
 <td></td>
 <td><span class="checkbox">Width [mm]:</span></td>
 <td><span class="checkbox">
 <input name="ext_width" type="text" id="ext_width" value="" maxlength="5" />
  ...
  <tr>
 <td></td>
 <td><span class="checkbox">Height [mm]:</span></td>
 <td><span class="checkbox">
