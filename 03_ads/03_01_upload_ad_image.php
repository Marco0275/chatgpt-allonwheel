...
// Recupera id_ads dalla sessione (impostato in 03_01_upload_advertising.php)
$id_ads = isset($_SESSION['id_ads']) ? (int)$_SESSION['id_ads'] : 0;
// Wizard unificato (rev. 7 lug): free -> 03_ads, premium -> 03_ads
...
header('Location: 03_insert_ad_gallery.php' . ($aow_lt === 'prem' ? '?lt=prem' : '') . '');
exit;
