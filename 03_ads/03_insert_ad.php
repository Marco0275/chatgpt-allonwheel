...
<div id="templatemo_wrapper">
  ...
  <div id="main"></div><div id="templatemo_content">
    ...
    $aow_form_action = $aow_is_guest ? '03_save_draft.php' : '03_01_upload_advertising.php';
    ?>
    <form action="<?php echo $aow_form_action; ?>" method="post" >
      ...
      <div class="form_row">
        ...
        &nbsp; </p>
        <p><a href="03_00_select_type.php" class="more">Change</a>
        </p>
...
<label for="description"><strong>Description:</strong></label><br/>
      ...
      <p><em>You will be able to upload the main image and a gallery in the next steps.</em></p>
