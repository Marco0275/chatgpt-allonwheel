...
<tr>
 <td width="37%"><span class="cleaner"><img src="../images/wrong-email.png" alt="" width="200" height="193" loading="lazy" decoding="async" /></span></td>
 <td width="63%"><strong>Retry</strong>...something is wrong!</td>
</tr>
 </table>
</div> <!-- end of content -->
